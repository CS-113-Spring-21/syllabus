...
% CS PLOs
% \begin{enumerate}
% \item Analysis: analyze a given situation and reduce it to one or more problems that can be solved via computer intervention.
% \item Design: design one or more computer-based solutions of a given problem and select the solution that is best under the circumstances.
% \item Programming: program a given solution in a variety of programming languages belonging to different paradigm.
% \item Implementation: design and implement software systems of varying complexity.
% \item Tools: work with the latest tools that support development, e.g., IDE's, version control systems, debuggers, profilers, and continuous build systems.
% \item Self-learning: research, learn, and apply requirements needed to implement a solution for a given high level problem description.
% \item Ethics and Awareness: foresee both impact and possible ramifications of computing practices
% \item Communication and Teamwork: work effectively in inter-disciplinary teams.
% \end{enumerate}
